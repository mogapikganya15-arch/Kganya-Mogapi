...
* **NQF Level 4: IT & Computer Science** 
  * Vuselela TVET College (Completed: 2025)
* **Cisco Networking Academy Certifications:**
  * Introduction to Networks (2025)
  * IT Essentials: PC Hardware and Software (2024)
...
* **Programming & Web Development:** HTML5, CSS3, JavaScript (ES6+)
* **Networking & Hardware:** Network configuration, PC diagnostics, hardware troubleshooting, software installation
* **Security:** Core cybersecurity principles, threat assessment, secure coding basics
...
* **GitHub:** [https://github.com/mogapikganya15-arch)
